...
def fetch_poster(movie_id):
    url =  "https://api.themoviedb.org/3/movie/{}?api_key=22b1f76df69601807bdb605d7e66b8b5&language=en-US".format(movie_id)
...
st.header("Movies Recommendation System Using Maachine Learning")
